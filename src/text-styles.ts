...
export const h2: StyleFunction = text => apply([chalk.bold, chalk.bgBlack, postLineBreak], text)
...
export const sectionTitle: StyleFunction = text => apply([text => `==================== ${text} =====================`, postLineBreak, preLineBreak, preLineBreak], text)
